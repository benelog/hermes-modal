...
- When adding several dated Token-section articles at once, insert each top-level bullet at its date-sorted position instead of appending as a batch; run `scripts/check-ai-trend-sort.py` afterward.
